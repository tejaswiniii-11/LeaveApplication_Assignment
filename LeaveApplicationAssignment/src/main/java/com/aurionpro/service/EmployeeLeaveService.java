...
public class EmployeeLeaveService {
    ...
    // New method to get leaves filtered by status
    public List<EmployeeLeave> getLeavesByStatus(String status) {
        List<EmployeeLeave> leaves = leaveDao.getLeavesByStatus(status);
        System.out.println("EmployeeLeaveService.getLeavesByStatus() returned " + (leaves == null ? "null" : leaves.size()));
        return leaves;
    }
